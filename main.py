...
df = spark.read.csv("/Users/admin/Downloads/taxi_zone_lookup (2).csv", header=True, inferSchema=True)

print(df.schema.json())

# df = spark.read.parquet("/Users/admin/Downloads/yellow_tripdata_2024-09.parquet")
# df = df.filter('trip_distance>10 and PULocationID = 93 and DOLocationID =68' )
# df.show()
# print(df.count())
#
...
# df = spark.read.parquet("/Users/admin/Downloads/yellow_tripdata_2024-09.parquet")
#
# print(df.filter("PULocationID=138 and DOLocationID=48" ).count())
#
#
# df.show(10)
